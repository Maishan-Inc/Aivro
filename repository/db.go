...
func migrateModels(db *gorm.DB) error {
	err := db.AutoMigrate(
		...
		&model.WorkflowShareStar{},
		&model.WorkflowCommunityPost{},
		&model.CanvasAssistantSession{},
		&model.Plan{},
		&model.PlanOrder{},
...
func databaseMigrationModelItems() []struct {
	...
	return []struct {
		...
		{"model.WorkflowShareStar", &model.WorkflowShareStar{}},
		{"model.WorkflowCommunityPost", &model.WorkflowCommunityPost{}},
		{"model.CanvasAssistantSession", &model.CanvasAssistantSession{}},
