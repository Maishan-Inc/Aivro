    ...
    return (
        <>
            <label className="col-span-2 block min-w-0 sm:col-span-1">
                ...
                <ModelPicker config={config} models={config.videoModels} value={model} onChange={(value) => updateConfig("videoModel", value)} fullWidth onMissingConfig={onMissingConfig} />
            </label>
